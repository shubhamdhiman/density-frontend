  ...
  return (
    <MobilePageS>
      ...
      <MobilePageSingleCont left="37%" zIndex={3}>
        ...
        <img src={PhoneLeft} alt="Phone Center" style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)' }} />
      </MobilePageSingleCont>

      {/* Center Phone */}
      <MobilePageSingleCont center={true} zIndex={4}>
        <img src={PhoneBackground} alt="Phone Background" />
        <img src={PhoneCenter} alt="Phone Center" style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)' }} />
      </MobilePageSingleCont>

      {/* Right Phone */}
      <MobilePageSingleCont right="22%" zIndex={3}>
        <img src={PhoneBackgroundSmall} alt="Phone Background" />
        <img src={PhoneRight} alt="Phone Center" style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', }} />
      </MobilePageSingleCont>
    </MobilePageS>
  );
}
